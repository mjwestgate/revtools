...
#'
#' This is a simple app for calculating, displaying and screening potential
#' duplicates in bibliographic data
#'
#' This app is effectively a wrapper for \code{\link{find_duplicates}}, with
#' the added option to manually screen pairs of duplicates to check the
#' results. Consequently, this is a more reliable method than
#' \code{\link{extract_unique_references}} of dealing with the duplicates
#' identified by \code{\link{find_duplicates}}, and for testing whether that
#' function has returned sensible results for a given dataset.
#'
...
#' allowing the user to customize their parameters for duplicate detection, and
#' visualise the results.
#' @seealso \code{\link{screen_titles}} or \code{\link{screen_abstracts}} for
#' manual screening of individual articles.
#' @examples
#'
